const messages = {
  ru: {
    ...
    aiChat: {
      title: 'Стилист-ассистент',
      subtitle: 'Подскажу, что надеть и что взять с собой',
      empty: 'Задайте вопрос или выберите одну из подсказок ниже.',
      placeholder: 'Например: что надеть в театр?',
      send: 'Отправить',
      sendAria: 'Отправить сообщение',
      clear: 'Очистить чат',
      loading: 'Думаю над ответом…',
      errorGeneric: 'Не удалось получить ответ ассистента.',
      errorEmpty: 'Введите вопрос ассистенту.',
      roleUser: 'Вы',
      roleAssistant: 'Ассистент',
      suggestionsTitle: 'Попробуйте спросить:',
      suggestions: {
        theater: 'Что надеть в театр?',
        travelWeek: 'Собираю чемодан на неделю в Европу',
        work: 'Что надеть в офис в холодную погоду?',
        date: 'Идея образа на свидание',
      },
      contextNoItems: 'Гардероб пока пуст.',
      contextNoOutfits: 'Сохранённых образов пока нет.',
    },
  },
} as const
